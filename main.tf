...
# Traffic ka path control karta hai
# Abhi simple Internet route hai
# Production mein Firewall/NVA ki taraf jata
# ═══════════════════════════════════════════════
resource "azurerm_route_table" "app" {
  ...
  # Default route - sab traffic
  route {
    name           = "default-route"
    address_prefix = "0.0.0.0/0"
    next_hop_type  = "Internet"
    # Production: next_hop_type = "VirtualAppliance"
    #             next_hop_in_ip_address = "<firewall-private-ip>"
  }
}

# Route Table ko App Subnet se attach karo
# subnet_id reference se dependency automatic create hoti hai
...
# ═══════════════════════════════════════════════
# ROUTE TABLE — DATA SUBNET
# Data tier ka traffic bhi control karo
# ═══════════════════════════════════════════════
...
# Route Table ko Data Subnet se attach karo
